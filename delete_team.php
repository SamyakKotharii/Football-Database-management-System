...
if(isset($_POST['Delete'])){
  $servername = "localhost";
    ...
    $sql="delete from team_info where Team_Name= '$Team_Name' ";
...
<img class="bg" src="fallback.jpg" alt="UEFA">
    ...
    <select id="Team_Name" name = "Team_Name" style="margin:10px;">
      <option disabled selected>-- Select Team Name to delete --</option>
      <?php
        $servername = "localhost";
        $username = "root";
        $password = "";
        ...
        $con = mysqli_connect($servername, $username, $password,$db);
          ...
          $records = mysqli_query($con, "SELECT DISTINCT Team_Name From team_info");  // Use select query here 

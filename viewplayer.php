...
<img class="bg" src="fallback.jpg" alt="UEFA">
    ...
    <div class="navbar">
      ...
      <div class="button">
      <form action="top_ten.php" method="post">
            <button class="add">Top 10 players</button> 
        </form>
      </div>
      <div class="container">
...
$sql="CALL `playerdetails`('$name');";
$result = mysqli_query($con,$sql);
    if ($result !== false && $result->num_rows > 0) {
        // output data of each row
        while($row = $result->fetch_assoc()) {
            echo " <br> Name: " . $row["Name"]." <br> &nbsp &nbsp  &nbsp- Team: " . $row["Team_Name"]. " <br> &nbsp &nbsp  &nbsp- Position: " . $row["Position"]. " <br> &nbsp &nbsp  &nbsp- Jersey: " . $row["Jersey"]. " <br> &nbsp &nbsp  &nbsp- Country: " . $row["Country"].  "<br> &nbsp &nbsp  &nbsp- Physical: " . $row["Physical"]. "<br> &nbsp &nbsp  &nbsp- Shooting: " . $row["Shooting"]."<br> &nbsp &nbsp  &nbsp- Pace: " . $row["Pace"]."<br> &nbsp &nbsp  &nbsp- Dribbling: " . $row["Dribbling"]."<br> &nbsp &nbsp  &nbsp- Passing: " . $row["Passing"]."<br> &nbsp &nbsp  &nbsp- Defending: " . $row["Defending"]."<br>";
        }
    } else {
        echo "0 results";
    }  

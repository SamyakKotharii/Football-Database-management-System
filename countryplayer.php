...
<img class="bg" src="fallback.jpg" alt="UEFA">
    ...
    <div class="navbar">
      ...
      <div class="container">
        <p style="color: white;">Select Country</p>
        <form method="post">
  
  <select id="Country" name ="Country" style="margin:10px;">
    ...
    <?php
      ...
      $con = mysqli_connect($servername, $username, $password,$db);
        ...
        $records = mysqli_query($con, "SELECT DISTINCT Country From player_profile");  // Use select query here 
...
$sql="CALL `country_player`('$name');";
$result = mysqli_query($con,$sql);
    if ($result !== false && $result->num_rows > 0) {
        // output data of each row
        
        while($row = $result->fetch_assoc()) {
            echo " <br> Player Name: " . $row["Name"]." <br> &nbsp &nbsp  &nbsp- Team Name: " . $row["Team_Name"]. " <br> &nbsp &nbsp  &nbsp- Position: " . $row["Position"]. " <br> &nbsp &nbsp  &nbsp- Jersey: " . $row["Jersey"].  "<br>";
        }
    } else {
        echo "0 results";
    }  

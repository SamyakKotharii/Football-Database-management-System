...
<img class="bg" src="fallback.jpg" alt="UEFA">
    ...
    <?php
                    ...
                    $sql="CALL `top_five_team`();";
                    $result = mysqli_query($con,$sql);
                    
                    if ($result->num_rows > 0) {
                        // output data of each row
                        while($row = $result->fetch_assoc()) {
                            echo " <br> Name: " . $row["Team_Name"]. " <br> &nbsp &nbsp  &nbsp- Year Founded: " . $row["Year_Founded"]. "<br> &nbsp &nbsp  &nbsp- Stadium: " . $row["Stadium"]."<br> &nbsp &nbsp  &nbsp- Title: " . $row["title"]."<br>";
                        }
                    } else {
                        echo "0 results";
                    }  
